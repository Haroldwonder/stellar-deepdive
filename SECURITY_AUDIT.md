...
Stellar Deepdive is a full-stack blockchain analytics platform for the Stellar network providing real-time payment analytics, anchor reliability scoring, corridor health metrics, and on-chain verification via Soroban smart contracts.
...
| File | Description |
|------|-------------|
| `contracts/stellar_deepdive/src/lib.rs` | Main contract |
