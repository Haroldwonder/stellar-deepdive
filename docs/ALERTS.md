...
The Stellar Deepdive platform includes a robust custom alerting system that allows users to define custom thresholds for various network metrics and receive notifications when these thresholds are breached.
