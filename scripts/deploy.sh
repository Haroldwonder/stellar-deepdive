...
# Blue-green deployment script for stellar-deepdive backend
# Usage: ./scripts/deploy.sh <environment> <image-tag>

AWS_REGION="us-east-1"
ECR_REPOSITORY="stellar-deepdive-backend"
CONTAINER_NAME="stellar-deepdive"
CONTAINER_PORT=8080
...
CLUSTER="stellar-deepdive-${ENVIRONMENT}"
TASK_FAMILY="stellar-deepdive-${ENVIRONMENT}"
CODEDEPLOY_APP="stellar-deepdive-${ENVIRONMENT}"
CODEDEPLOY_GROUP="stellar-deepdive-${ENVIRONMENT}-dg"
