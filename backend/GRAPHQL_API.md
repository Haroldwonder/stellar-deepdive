...
The Stellar Deepdive backend now includes a GraphQL API layer alongside the existing REST API, enabling clients to request exactly the data they need with flexible querying capabilities.
