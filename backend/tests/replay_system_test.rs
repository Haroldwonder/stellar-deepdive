...
use stellar_deepdive_backend::replay::{
...
async fn test_replay_range() {
    use stellar_deepdive_backend::replay::config::ReplayRange;
...
async fn test_replay_storage() {
    ...
    // Create metadata
    let metadata = stellar_deepdive_backend::replay::ReplayMetadata {
        session_id: "test-session".to_string(),
        config: ReplayConfig::default(),
        status: stellar_deepdive_backend::replay::ReplayStatus::Pending,
        started_at: Utc::now(),
        ended_at: None,
        checkpoint: None,
    };
